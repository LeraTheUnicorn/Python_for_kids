...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        ...
        self.game.tk.bind_all('<KeyPress-Left>', self.turn_left)
        self.game.tk.bind_all('<KeyPress-Right>', self.turn_right)
        self.game.tk.bind_all('<KeyRelease-Left>', self.stop_left)
        self.game.tk.bind_all('<KeyRelease-Right>', self.stop_right)
        self.game.tk.bind_all('<Key-space>', self.jump)
