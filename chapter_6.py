...
print()
age = 8
[print(num) for num in ((x for x in range(1, age + 1) if x % 2 == 0)
                        if age % 2 == 0 else (x for x in range(1, age + 2) if x % 2 != 0))]
...
for year in range(1, 16):
    current_earth_weight = earth_weight + \
        (year - 1)  # прибавляем каждый год по 1 кг
